...
回归脚本 **699 项全部通过**（2026-09-23 逐套件本机复现）：`verify:all` **311**（`store` 22 / `errors` 34 / `guards` **88** / `graph` **67** / **`symbolic` 69** / **`vision` 31**）、
`verify:flow` **56**（真实 HTTP）、`verify:dist` **11**（构建产物形态，含**运行形态自证**）、
